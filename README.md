...
*Four real pairs through the four stages: raw CAD polygons, the inferred yield
raster, the SEM capture, and the answer. Ground truth and prediction are drawn
together, with a ±6 px inset — at 0.08 px the two outlines are otherwise the
same line.*
